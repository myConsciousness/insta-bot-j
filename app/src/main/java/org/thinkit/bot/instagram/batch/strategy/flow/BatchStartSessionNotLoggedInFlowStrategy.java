...
public class BatchStartSessionNotLoggedInFlowStrategy implements BatchFlowStrategy {
    ...
    public FlowBuilder<FlowJobBuilder> createJobFlowBuilder(@NonNull final JobBuilder jobBuilder,
        ...
        return jobBuilder.flow(batchStepCollections.getStartSessionStep())
                .next(batchStepCollections.getExecuteAutoLoginStep())
                .next(batchStepCollections.getExecuteAutoScrapeUserProfileStep())
                .next(batchStepCollections.getExecuteAutoDiagnoseFollowStep())
